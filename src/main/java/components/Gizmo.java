...
public class Gizmo extends Component{
    ...
    private void setInactive() {
        ...
        this.xAxisSprite.setColor(new Vector4f(0.f, 0.f, 0.f, 0.f));
        this.yAxisSprite.setColor(new Vector4f(0.f, 0.f, 0.f, 0.f));
    }
    ...
    private boolean checkYHoverState() {
        ...
        if (mousePos.x <= yAxisObject.transform.position.x + (gizmoHeight / 2.0f) &&
                mousePos.x >= yAxisObject.transform.position.x - (gizmoHeight / 2.0f) &&
